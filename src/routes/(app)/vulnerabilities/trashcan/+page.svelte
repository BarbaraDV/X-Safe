...
<div class="flex flex-col space-y-8">
  ...
  >
    <div class="flex space-x-2 items-center text-xl">
      ...
      <h1 class="font-bold">
        <span> Vulnerabilidades deshechadas </span>
      </h1>
    </div>
    <button
      class="bg-red-500 p2 rounded transition-200 hover:bg-red-400 text-white flex items-center space-x-2 text-center justify-center"
      on:click={clearTrash}
    >
      <un-i-carbon-trash-can />
      <span class="text-xs">Vaciar papelera</span>
    </button>
  </div>
  <div
